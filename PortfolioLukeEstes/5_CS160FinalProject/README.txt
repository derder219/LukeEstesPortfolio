Final Project for my class CS160, we were required to, in groups, create an app that was based off the theme disabilities.
This project focus was for us to work in groups to actually create something we might present before companies as an idea for a new app.
